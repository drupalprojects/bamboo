Version 1.6, November 29, 2012

-- SUMMARY --

Bamboo is a responsive Drupal 7 theme designed and developed
by Danny Englander (@highrockmedia). Based on the CSS Skeleton Framework,
it allows for a choice of backgrounds, color palettes, sidebars and fonts in the
theme's settings page.

Bamboo is aimed at users who want to get a nice looking theme up and running
fast, and may not want to take the time to create a sub-theme
